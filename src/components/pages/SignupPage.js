  ...
  componentDidMount() {
    ...
    validateUser(user)
      ...
      .catch(err => {
        ...
        /** ++++++++++++++++++++++++++++++++++++++++++++
         *
         *  Hey Jamie, this is where your code breaks.
         *  The validateUser() function always runs
         *  into this error and then pushes the "/"
         *  onto the history stack which then redirects
         *  to the login when no user is logged in.
         *
         *  You should look into your console from time
         *  to time when debugging something like this.
         *  It has nothing to do with React Router. ;)
		 *
		 *  Also I strongly advice you to use
		 *  these 2 tools:
		 *
		 *  1. PHPStorm / WebStorm
		 *  2. Prettier (Code formatting)
		 *
		 *  It helps to produce cleaner code. ;)
         *
         ** +++++++++++++++++++++++++++++++++++++++++++ */
          ...
          {!isLoading &&
            isRegistered && (
              <Card fluid={true}>
                ...
                <Card.Content>
                  Usted ya se encuentra registrado, para acceder por favor haga
                  click <Link to="/login">aquí</Link>
                </Card.Content>
              </Card>
            )}
          {!isLoading &&
            !isRegistered && (
              <Card fluid={true}>
                ...
                <Card.Content>
                  <SignupForm submit={this.submit} data={data} />
                </Card.Content>
              </Card>
            )}
        </Grid.Column>
